...
窗口顶部提供常用操作的快捷入口——新建笔记、导入、导出、[快速访问](../managing-notes/quick-access-history.md)、[任务](../productivity/tasks.md)、[统一入口](../search/united-entry.md)、[设置](../customization/settings.md)等。**新建 → 快速笔记（Quick Note）**让你在还没决定归属之前就能立即记下想法。
